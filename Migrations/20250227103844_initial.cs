    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Aosurgeries", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaidTill = table.Column<DateTime>(type: "datetime", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IABP_DATE = table.Column<DateTime>(type: "datetime", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ICU_ARRIVAL_DATE = table.Column<DateTime>(type: "datetime", nullable: false),
                    EXTUBATION_DATE = table.Column<DateTime>(type: "datetime", nullable: false),
                    DISCHARGE_DATE = table.Column<DateTime>(type: "datetime", nullable: false),
                    ICU_DISCHARGE_DATE = table.Column<DateTime>(type: "datetime", nullable: false),
                    ICU_ARRIVAL_1_DATE = table.Column<DateTime>(type: "datetime", nullable: false),
                    EXTUBATION_1_DATE = table.Column<DateTime>(type: "datetime", nullable: false),
                    ICU_DISCHARGE_1_DATE = table.Column<DateTime>(type: "datetime", nullable: false),
                    REINTUBATION_DATE = table.Column<DateTime>(type: "datetime", nullable: false),
                    ...
                    complicatie_9 = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    mortality_date = table.Column<DateTime>(type: "datetime", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfSurgery = table.Column<DateTime>(type: "datetime", nullable: false),
